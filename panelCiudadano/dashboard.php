        ...
        <div class="stat-grid grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div class="stat-card bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-full bg-[#E8F1F2] flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" fill="#0F4C5C" class="w-5 h-5">
          ...
          <div class="stat-card bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-full bg-[#FAEEDA] flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" fill="#633806" class="w-5 h-5">
          ...
          <div class="stat-card bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-full bg-[#E6F1FB] flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" fill="#0C447C" class="w-5 h-5">
          ...
          <div class="stat-card bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-full bg-[#EAF3DE] flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" fill="#27500A" class="w-5 h-5">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z" />
                </svg>
              </div>
          ...
          <div class="stat-card bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 rounded-full bg-[#FCEBEB] flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" fill="#791F1F" class="w-5 h-5">
