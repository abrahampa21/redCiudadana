...
if (isset($_POST["btn-registro"])) {
  ...
  if (!validar_contraseña($pass)) {
    ...
    if ($resultado_verificar && $resultado_verificar->num_rows > 0) {
      ...
      $registro = $conn->prepare("INSERT INTO usuario(nombre,correo,password,telefono,id_rol) VALUES (?,?,?,?, 2)");
    ...
    <div class="container">
      <div class="icon-login">
        <svg viewBox="0 0 24 24">
          <path d="M12 2c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6 2.69-6 6-6zm0 12c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4zm8-6h-4v-2h4v2z" />
